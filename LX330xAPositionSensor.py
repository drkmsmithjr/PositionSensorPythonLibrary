...
if __name__ == "__main__":
   ...
   while True:
         print(x.SENTD(), round(x.SENTD()/4096.0*100,2))
         print("Duty Ratio: %s SENT_duty: %s Frequency: %s SENT: %s " % (round(y.DutyRatio(),2),(round(x.SENTD()/4096.0*100,2)),round(y.PWMFreq(),2),x.SENTD()))
         time.sleep(0.1)
